...
int[,] numbers = new int[masSize, masSize];
FillArrayRandomNumbers(numbers);
PrintArray(numbers);
...
Console.WriteLine($"Строка с наименьшей суммой элементов - {line} строка.");
Console.WriteLine($"Сумма элементов в {line} строке = {minSum}.");
